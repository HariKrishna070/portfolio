...
const PROJECTS = [
  ...
  { title: 'Covid-19 India Data Analysis dashboard', category: 'tableau',       img: asset('/assets/images/covid19Dashboard.png'),                   href: 'https://public.tableau.com/app/profile/hari.krishna.bekkam/viz/Covid-19inIndiaDashboardAnalysis_17147136888470/Dashboard1?publish=yes' },
  { title: 'Customer Churn Analysis and Prediction', category: 'data analysis', img: asset('/assets/images/churn.jpg'),                              href: 'https://github.com/HariKrishna070/Customer-Churn-and-Sentiment-analysis/blob/main/churn-analysis-in-e-commerce.ipynb' },
  { title: 'Sentiment Analysis',                   category: 'data analysis',   img: asset('/assets/images/sentiment.jpg'),                          href: 'https://github.com/HariKrishna070/Customer-Churn-and-Sentiment-analysis/blob/main/BA_Assignment_SentimentAnalysis.ipynb' },
